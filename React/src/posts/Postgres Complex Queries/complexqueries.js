...
<body class="c2">
    <p class="c0"><span class="c1">When I first started learning sql, I was taking a databases class using postgresql.
    ...
    <p class="c0"><span class="c1">The object of this query is to return all of the content in a portfolio post. In
            ...
            displayed. When I first started writing this query, I did all inner joins and my query returned nothing. I
            was stumped for a bit until I came to the realization that, when a text has a value an image is null and
            when text is null and an image has a value. That means that an inner join can&rsquo;t be used to get a
            complete portfolio post. All of the other tables can use simple inner joins because they all exist at the
            same time. It turned out using left joins on the text and image tables allowed me to get all of the content
            for a complete post. </span></p>
</body>
