...
const Home = () =>{
    ...
    return(
        <div className="bg-fixed bg-cover" style={{backgroundImage: `url(${image})`}}>
            <section className="relative flex justify-center min-h-screen pt-12 lg:pt-36 px-8 bg-black bg-opacity-50">
                ...
                strengths and we can help each other become stronger in areas that we may be weak in. If we all lift those around us, we all become excellent together. 
                    ...
                    <div data-testid="resume" className="flex justify-center pt-8 bg-opacity-75 min-h-screen pt-12 lg:pt-36 px-8 bg-opacity-75">
